...
class PretrainedVocab(SetVocab):
  ...
  #=============================================================
  def __init__(self, pretrained_file=None, name=None, config=None, is_eval=False):
    """"""
    ...
    super(PretrainedVocab, self).__init__(config=config, is_eval=is_eval)
...
class LemmaPretrainedVocab(PretrainedVocab, cv.LemmaVocab):
  pass
class PREDICATEPretrainedVocab(PretrainedVocab, cv.PREDICATEVocab):
  pass
class PSENSEPretrainedVocab(PretrainedVocab, cv.PSENSEVocab):
  pass
