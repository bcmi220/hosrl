...
class FrameVocab(TokenVocab):

  # =============================================================
  def __init__(self, *args, **kwargs):
    """"""
    super(FrameVocab, self).__init__(*args, **kwargs)
    return

  # =============================================================
  def get_linear_classifier(self, layer, token_weights, last_output=None, variable_scope=None, reuse=False, debug=False):
    """"""
    ...
    outputs['targets'] = targets
    outputs['probabilities'] = probabilities
    outputs['loss'] = loss * self.loss_frame_interpolation
    ...
    return outputs
  @property
  def loss_frame_interpolation(self):
    return self._config.getfloat(self, 'loss_frame_interpolation')
...
class FrameTokenVocab(FrameVocab, cv.UFeatsVocab):
  pass
#--------------------------------------------------------------------------
...
class PREDICATETokenVocab(TokenVocab, cv.PREDICATEVocab):
	pass
class PSENSETokenVocab(TokenVocab, cv.PSENSEVocab):
	pass
