...
class SubtokenVocab(CountVocab):
  ...
  def __init__(self, config=None, is_eval=False):
    ...
    super(SubtokenVocab, self).__init__(config=config, is_eval=is_eval)
...
class LemmaSubtokenVocab(SubtokenVocab, cv.LemmaVocab):
  pass
class PREDICATESubtokenVocab(SubtokenVocab, cv.PREDICATEVocab):
  pass
class PSENSESubtokenVocab(SubtokenVocab, cv.PSENSEVocab):
  pass
