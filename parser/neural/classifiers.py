...
# import pdb
#***************************************************************
def hidden(layer, hidden_size, hidden_func=nonlin.relu, hidden_keep_prob=1., reuse=False):
	""""""
...
#===============================================================
def hiddens(layer, hidden_sizes, hidden_func=nonlin.relu, hidden_keep_prob=1., reuse=False):
	""""""
	#pdb.set_trace()
	layer_shape = nn.get_sizes(layer)
	input_size = layer_shape.pop()
