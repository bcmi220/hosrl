...
for line in flines:
	...
	#pdb.set_trace()
	#sent="vsub "+"CUDA_VISIBLE_DEVICES="+std(index)+" /public/sist/home/lizhao/.anaconda3/envs/parser2/bin/python -u main.py train GraphParserNetwork --config_file config_srl/dozat_no_lc_dm_new0.cfg --noscreen" --name dozat_no_lc_dm_new0 --node 13
